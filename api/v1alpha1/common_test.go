...
func TestMatch(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			name:        "test",
			filterCond:  map[string]FilterCond{"test": {KeepDeprecated: false, Keep: true}},
		...
		},
		{
			...
			name:        "test",
			filterCond:  map[string]FilterCond{"test": {KeepDeprecated: true, Keep: true}},
			versions: []*hrepo.ChartVersion{
				{Metadata: &chart.Metadata{Version: "1.0.0", Deprecated: true}},
				{Metadata: &chart.Metadata{Version: "2.0.0", Deprecated: false}},
			},
		...
		},
		{
			description: "there is no versionedFilterCond to determine if the chart package is retained or not",
			name:        "test",
			filterCond:  map[string]FilterCond{"test": {KeepDeprecated: false, Keep: false}},
			versions:    []*hrepo.ChartVersion{{Metadata: &chart.Metadata{Version: "1.0.0", Deprecated: true}}},
			keep:        false,
			expected:    nil,
		},
		{
			description: "there is no versionedFilterCond to determine if the chart package is retained or not",
			name:        "test",
			filterCond:  map[string]FilterCond{"test": {KeepDeprecated: true, Keep: false}},
			versions: []*hrepo.ChartVersion{
				{Metadata: &chart.Metadata{Version: "1.0.0", Deprecated: true}},
				{Metadata: &chart.Metadata{Version: "2.0.0", Deprecated: false}},
			},
		...
		// keep,accurate
		{
			...
			name:        "test",
			filterCond: map[string]FilterCond{"test": {Keep: true, KeepDeprecated: true, VersionedFilterCond: &VersionedFilterCond{
		...
		},
		{
			...
			name:        "test",
			filterCond:  map[string]FilterCond{"test": {Keep: true, KeepDeprecated: true}},
			versions: []*hrepo.ChartVersion{
				{Metadata: &chart.Metadata{Version: "1.0.0", Deprecated: true}},
				{Metadata: &chart.Metadata{Version: "2.0.0", Deprecated: false}},
				{Metadata: &chart.Metadata{Version: "3.0.0", Deprecated: false}},
		...
		},
		{
			...
			name:        "test",
			filterCond: map[string]FilterCond{"test": {Keep: true, KeepDeprecated: false, VersionedFilterCond: &VersionedFilterCond{
				Versions: []string{"1.0.0", "2.0.0"},
			}}},
			versions: []*hrepo.ChartVersion{
				{Metadata: &chart.Metadata{Version: "1.0.0", Deprecated: true}},
		...
		// ignore, accurately
		{
			...
			name:        "test",
			filterCond: map[string]FilterCond{"test": {Keep: false, KeepDeprecated: true, VersionedFilterCond: &VersionedFilterCond{
				Versions: []string{"1.0.0", "2.0.0"},
			}}},
			versions: []*hrepo.ChartVersion{
				{Metadata: &chart.Metadata{Version: "1.0.0", Deprecated: true}},
		...
		},
		{
			...
			name:        "test",
			filterCond:  map[string]FilterCond{"test": {Keep: false, KeepDeprecated: true}},
			versions: []*hrepo.ChartVersion{
				{Metadata: &chart.Metadata{Version: "1.0.0", Deprecated: true}},
				{Metadata: &chart.Metadata{Version: "2.0.0", Deprecated: false}},
				{Metadata: &chart.Metadata{Version: "3.0.0", Deprecated: false}},
		...
		},
		{
			...
			name:        "test",
			filterCond: map[string]FilterCond{"test": {Keep: false, KeepDeprecated: false, VersionedFilterCond: &VersionedFilterCond{
				Versions: []string{"1.0.0", "2.0.0"},
			}}},
			versions: []*hrepo.ChartVersion{
				{Metadata: &chart.Metadata{Version: "1.0.0", Deprecated: true}},
